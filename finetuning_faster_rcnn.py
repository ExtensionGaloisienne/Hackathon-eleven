...
pretrained = models.detection.fasterrcnn_resnet50_fpn(pretrained=True)
...
class MyFasterRCNN(nn.Module):
    def __init__(self, my_pretrained_model):
        ...
        self.my_new_layers = nn.Sequential(nn.Linear(91, 4),
                                           nn.ReLU(),
                                           nn.Softmax(4))
...
extended_model = MyFasterRCNN(my_pretrained_model=pretrained)
extended_model
...
def get_prediction(img_path, threshold):
    ...
    pred = extended_model([img])  # Pass the image to the model
    print(pred)
    pred_class = [
...
dir_path = "/Users/redabendjellountouimi/Git/Hackathon-eleven/data/Detection_Train_Set/Detection_Train_Set_Img"
